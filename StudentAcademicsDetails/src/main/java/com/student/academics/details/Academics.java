...
public class Academics {
	...
	@Id
	@Column(name = "USN", unique = true, length = 15)
	private String usn;
	@Column(name = "first_year", length = 15)
	private int year1;
	@Column(name = "second_year", length = 15)
	private int year2;
	@Column(name = "third_year", length = 15)
	private int year3;
	@Column(name = "fourth_year", length = 15)
	private int year4;
	@Column(name = "aggregate_marks", length = 15)
